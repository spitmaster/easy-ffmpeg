...
- 非 FFmpeg 的处理引擎
- 移动端 / 平板专门适配
- ~~嵌入 webview（走 Electron / Tauri / Wails 路线）~~ —— **v0.4.0 撤销**：新增 Wails 桌面版作为 Web 版的并列产物（不替换 Web 版）。详见 [v0.4.0.md](v0.4.0.md) §8 与 [v0.4.0-architecture.md](v0.4.0-architecture.md)。
