...
> **多素材 / 多轨道剪辑**自 v0.6.0 起由独立的**多轨剪辑 Tab** 提供,见 [tabs/multitrack/product.md](../multitrack/product.md)。本 Tab 维持单视频定位不变。

- ~~多素材剪辑(素材库、多段视频拼接)~~ — **v0.6.0 由多轨剪辑 Tab 提供**
- ~~多轨道叠加~~ — **v0.6.0 由多轨剪辑 Tab 提供全屏 overlay**;PiP / 画中画 / 绿幕仍留 v2(0.7.x 进阶里程碑)
- 转场(淡入淡出、擦除等)
- 音量包络 / 关键帧动画 / 调色
- 滤镜(模糊、锐化、色彩调整)
- 文字 / 贴纸 / 水印
